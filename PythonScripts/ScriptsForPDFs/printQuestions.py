...
def print_question_to_exam(database_info, version, file_name, DIR, response_type):
...
""" %(code_name, version))
    ...
    examFile.write('\n')
    examFile.close()
def print_question_to_key(database_info, version, code_name, file_name, DIR, response_type):
    display_stem_type, display_stem, display_problem_type, display_problem, display_options_type, choices, choice_comments, solution, answer_letter, general_comment = database_info
    ...
    for index in range(0, total):
        ...
        if question_dict.get("Code Name") == code_name:
            ...
            if to_do == "Print questions to exam":
                print_question_to_exam(database_info, version, full_file_name, DIR, response_type)
            elif to_do == "Print questions to key":
                print_question_to_key(database_info, version, code_name, full_file_name, DIR, response_type)
