...
\hline
\textbf{Pop.} & 60000 & 60013 & 60021 & 60027 & 60032 & 60035 & 60038 & 60041 & 60043
\end{tabular} 
...
\begin{center}
    \textit{ The half-life of an element is the amount of time it takes for the element to decay to half of its initial starting amount. There is initially 935 grams of element $X$ and after 20 years there is 116 grams remaining. }
\end{center}
...
\begin{center}
    \textit{ Uranium is taken out of the reactor with a temperature of $140^{\circ}$ C and is placed into a $10^{\circ}$ C bath to cool. After 31 minutes, the uranium has cooled to $71^{\circ}$ C. }
\end{center}


The solution is \( k = -0.02441 \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( k = -0.02680 \)
...
\begin{center}
    \textit{ A newly discovered bacteria, $\alpha$, is being examined in a lab. The lab started with a petri dish of 3 bacteria-$\alpha$. After 3 hours, the petri dish has 75 bacteria-$\alpha$. Based on similar bacteria, the lab believes bacteria-$\alpha$ doubles after some undetermined number of minutes. }
\end{center}
...
\item \( \text{About } 368 \text{ minutes} \)
...
\item \( \text{About } 549 \text{ minutes} \)
...
\begin{center}
    \textit{ Uranium is taken out of the reactor with a temperature of $160^{\circ}$ C and is placed into a $18^{\circ}$ C bath to cool. After 18 minutes, the uranium has cooled to $113^{\circ}$ C. }
\end{center}


The solution is \( k = -0.02233 \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( k = -0.02896 \)
...
\begin{center}
    \textit{ The half-life of an element is the amount of time it takes for the element to decay to half of its initial starting amount. There is initially 864 grams of element $X$ and after 16 years there is 123 grams remaining. }
\end{center}
