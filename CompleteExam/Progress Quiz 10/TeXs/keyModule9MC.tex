...
The solution is \( C(h) = -2.83 h + 709.80 \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 4.04 h \)
...
The solution is \( C(h) = 1.64 h + 225.00 \), which is option B.\begin{enumerate}[label=\Alph*.]
...
* This is the correct option as the model should be $B(x) = 1192 - 9800 x$.
\end{enumerate}
