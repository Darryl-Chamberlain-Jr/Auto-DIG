...
\[ \lim_{x \rightarrow -9^+} \frac{-2}{(x-9)^9}+1 \]

The solution is \( f(-9) \), which is option C.\begin{enumerate}[label=\Alph*.]
\item \( \infty \)
...
The solution is \( \{ 4.1000, 4.0100, 4.0010, 4.0001 \} \), which is option E.\begin{enumerate}[label=\Alph*.]
...
\litem{
Evaluate the one-sided limit of the function $f(x)$ below, if possible.
\[ \lim_{x \rightarrow 8^-} \frac{-2}{(x-8)^7}+4 \]
...
\[ \lim_{x \rightarrow 9} \frac{\sqrt{6x - 18} - 6}{5x - 45} \]

The solution is \( 0.100 \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( 0.490 \)
...
The solution is \( f(x) \text{ is close to or exactly } 11.333 \text{ when } x \text{ is close to } 4 \), which is option D.\begin{enumerate}[label=\Alph*.]
...
\litem{
Evaluate the limit below, if possible.
\[ \lim_{x \rightarrow 8} \frac{\sqrt{8x - 48} - 4}{4x - 32} \]

The solution is \( 0.250 \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( \infty \)
...
The solution is \( \{ 9.1000, 9.0100, 9.0010, 9.0001 \} \), which is option D.\begin{enumerate}[label=\Alph*.]
