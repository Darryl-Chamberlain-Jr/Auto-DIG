...
The solution is \( C(h) = -1.31 h + 763.20 \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 2.93 h \)
...
* This is the correct option as the model should be $C(x) = 1644 x$.
\end{enumerate}
...
The solution is \( C(h) = -1.68 h + 727.20 \), which is option B.\begin{enumerate}[label=\Alph*.]
...
* This is the correct option as the model should be $I(x) = 6600$.
\end{enumerate}
