...
The solution is \( C(h) = -1.85 h + 441.90 \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 3.06 h \)
...
The solution is \( 19 t \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( 216 t \)
...
The solution is \( B(x) = 6800 - 1180 x \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( B(x) = 5980 x \)
...
The solution is \( C(h) = 2.60 h + 544.80 \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 4.87 h \)
...
The solution is \( I(x) = 6600 \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( I(x) = 6000 x + 600 \)
