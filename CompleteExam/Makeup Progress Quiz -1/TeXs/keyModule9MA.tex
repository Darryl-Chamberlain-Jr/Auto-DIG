...
The solution is \( \text{Linear} \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( \text{Linear} \)
...
* This is the correct option as the model should be $C(x) = 1364 x$.
\end{enumerate}
...
The solution is \( I(x) = 11000 \), which is option C.\begin{enumerate}[label=\Alph*.]
\item \( I(x) = 11000 x \)
...
The solution is \( C(h) = 1.60 h + 223.30 \), which is option D.\begin{enumerate}[label=\Alph*.]
...
The solution is \( 0.416 D \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( 0.416 D \)
...
The solution is \( C(h) = 1.63 h + 614.40 \), which is option C.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 4.19 h \)
