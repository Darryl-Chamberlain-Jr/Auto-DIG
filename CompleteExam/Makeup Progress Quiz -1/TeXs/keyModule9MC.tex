...
The solution is \( C(x) = 1204 x \), which is option C.\begin{enumerate}[label=\Alph*.]
\item \( C(x) = 826 x \)
...
The solution is \( C(x) = 1680 x \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( C(x) = 1320 \)
...
The solution is \( C(h) = -1.49 h + 970.50 \), which is option A.\begin{enumerate}[label=\Alph*.]
...
The solution is \( C(h) = 1.88 h + 318.50 \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 4.33 h \)
