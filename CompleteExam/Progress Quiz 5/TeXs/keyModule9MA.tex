...
\end{center}
The solution is \( C(h) = 1.27 h + 540.00 \), which is option D.\begin{enumerate}[label=\Alph*.]
...
\end{center}
The solution is \( \text{Subset of the Rational numbers} \), which is option E.\begin{enumerate}[label=\Alph*.]
...
\textbf{Pop} &20000 &19965 &19945 &19930 &19919 &19910 &19902 &19896 &19890\end{tabular}The solution is \( \text{Logarithmic} \), which is option A.\begin{enumerate}[label=\Alph*.]
...
* This is the correct option as the model should be $I(x) = 7600$.
\end{enumerate}
...
\end{center}
The solution is \( C(h) = 2.09 h + 329.00 \), which is option C.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 5.38 h \)
...
\end{center}
The solution is \( 0.408 D \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( 480.000 D \)
...
\begin{tabular}{c|c|c|c|c|c|c|c|c|c}
\textbf{Year} &1 &2 &3 &4 &5 &6 &7 &8 &9\tabularnewline \hline
\textbf{Pop} &100060 &100180 &100540 &101620 &104860 &114580 &143740 &231220 &493660\end{tabular}The solution is \( \text{Exponential} \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( \text{Non-Linear Power} \)
...
\end{center}
The solution is \( 0.400 D \), which is option C.\begin{enumerate}[label=\Alph*.]
\item \( 24.000 D \)
