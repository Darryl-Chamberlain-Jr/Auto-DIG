...
\textbf{Pop} &50027 &50057 &50095 &50125 &50147 &50177 &50215 &50245 &50267\end{tabular}The solution is \( \text{Non-Linear Power} \), which is option C.\begin{enumerate}[label=\Alph*.]
\item \( \text{Linear} \)
...
* This is the correct option as the model should be $B(x) = 1060 - 8400 x$.
\end{enumerate}
...
\end{center}
The solution is \( 0.425 D \), which is option C.\begin{enumerate}[label=\Alph*.]
\item \( 400.000 D \)
...
\begin{tabular}{c|c|c|c|c|c|c|c|c|c}
\textbf{Year} &1 &2 &3 &4 &5 &6 &7 &8 &9\tabularnewline \hline
\textbf{Pop} &70027 &70057 &70095 &70125 &70147 &70177 &70215 &70245 &70267\end{tabular}The solution is \( \text{Non-Linear Power} \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( \text{Linear} \)
...
\end{center}
The solution is \( C(h) = 1.60 h + 207.20 \), which is option C.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 3.39 h \)
...
\end{center}
The solution is \( C(h) = 2.46 h + 792.30 \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 6.63 h \)
...
* This is the correct option as the model should be $B(x) = 1100 - 5800 x$.
\end{enumerate}
...
\end{center}
The solution is \( B(x) = 9800 - 1416 x \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( B(x) = 8696 x \)
