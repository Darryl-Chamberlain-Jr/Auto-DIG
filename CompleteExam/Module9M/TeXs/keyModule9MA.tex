...
The solution is \( I(x) = 6800 \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( I(x) = 6800 x \)
...
The solution is \( C(h) = -2.89 h + 1587.00 \), which is option C.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 5.46 h \)
...
The solution is \( C(h) = -1.83 h + 1012.00 \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 3.49 h \)
...
The solution is \( C(x) = 1148 x \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( C(x) = 1148 x \)
...
The solution is \( 0.575 D \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( 0.575 D \)
