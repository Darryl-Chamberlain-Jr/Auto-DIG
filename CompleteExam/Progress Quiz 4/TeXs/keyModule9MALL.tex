...
* This is the correct option as the model should be $C(x) = 1236 x$.
\end{enumerate}
...
\end{center}
The solution is \( C(x) = 1540 x \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( C(x) = 1210 x \)
...
\begin{tabular}{c|c|c|c|c|c|c|c|c|c}
\textbf{Year} &1 &2 &3 &4 &5 &6 &7 &8 &9\tabularnewline \hline
\textbf{Pop} &99974 &99936 &99906 &99884 &99854 &99816 &99786 &99764 &99734\end{tabular}The solution is \( \text{Non-Linear Power} \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( \text{Logarithmic} \)
...
* This is the correct option. Since the time spent on each path was equal, the distance of each path must be different. The model would be $0.200D_u + 0.100D_d + 0.125D_f$, where $D_u$ is distance traveling up the hill, $D_d$ is distance traveling down, and $D_f$ is distance traveling on a flat part.
\item \( \text{The model cannot be found with the information provided.} \)
...
\end{center}
The solution is \( C(h) = -1.04 h + 357.00 \), which is option D.\begin{enumerate}[label=\Alph*.]
...
\begin{tabular}{c|c|c|c|c|c|c|c|c|c}
\textbf{Year} &1 &2 &3 &4 &5 &6 &7 &8 &9\tabularnewline \hline
\textbf{Pop} &79977 &79965 &79937 &79925 &79897 &79885 &79857 &79845 &79817\end{tabular}The solution is \( \text{Non-Linear Power} \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( \text{Linear} \)
...
\end{center}
The solution is \( C(h) = 2.95 h + 786.60 \), which is option B.\begin{enumerate}[label=\Alph*.]
...
\end{center}
The solution is \( B(x) = 10800 - 1208 x \), which is option B.\begin{enumerate}[label=\Alph*.]
