...
\end{center}
The solution is \( C(x) = 1504 x \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( C(x) = 1504 \)
...
\begin{tabular}{c|c|c|c|c|c|c|c|c|c}
\textbf{Year} &1 &2 &3 &4 &5 &6 &7 &8 &9\tabularnewline \hline
\textbf{Pop} &60020 &60040 &60060 &60080 &60100 &60120 &60140 &60160 &60180\end{tabular}The solution is \( \text{Linear} \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( \text{Non-Linear Power} \)
...
\end{center}
The solution is \( B(x) = 11400 - 1180 x \), which is option A.\begin{enumerate}[label=\Alph*.]
...
\end{center}
The solution is \( C(h) = 2.16 h + 590.90 \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 5.27 h \)
...
\end{center}
The solution is \( C(h) = 1.20 h + 432.60 \), which is option C.\begin{enumerate}[label=\Alph*.]
