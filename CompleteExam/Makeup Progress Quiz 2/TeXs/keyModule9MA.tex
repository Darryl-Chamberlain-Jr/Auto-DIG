...
* This is the correct option as the model should be $C(x) = 1556 x$.
\end{enumerate}
...
\end{center}
The solution is \( 15 t \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( 0.676 t \)
...
* This is the correct option as the model should be $I(x) = 11800$.
\end{enumerate}
...
\textbf{Pop} &60000 &59979 &59967 &59958 &59951 &59946 &59941 &59937 &59934\end{tabular}The solution is \( \text{Logarithmic} \), which is option D.\begin{enumerate}[label=\Alph*.]
...
\end{center}
The solution is \( C(h) = -2.02 h + 1489.40 \), which is option B.\begin{enumerate}[label=\Alph*.]
...
\end{center}
The solution is \( C(h) = -2.27 h + 1272.60 \), which is option A.\begin{enumerate}[label=\Alph*.]
