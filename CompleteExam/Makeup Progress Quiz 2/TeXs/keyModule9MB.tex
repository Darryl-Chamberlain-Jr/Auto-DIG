...
\end{center}
The solution is \( B(x) = 7800 - 1736 x \), which is option D.\begin{enumerate}[label=\Alph*.]
...
\textbf{Pop} &59960 &59920 &59880 &59840 &59800 &59760 &59720 &59680 &59640\end{tabular}The solution is \( \text{Linear} \), which is option D.\begin{enumerate}[label=\Alph*.]
...
\end{center}
The solution is \( C(h) = -1.15 h + 1106.60 \), which is option D.\begin{enumerate}[label=\Alph*.]
...
\begin{tabular}{c|c|c|c|c|c|c|c|c|c}
\textbf{Year} &1 &2 &3 &4 &5 &6 &7 &8 &9\tabularnewline \hline
\textbf{Pop} &100027 &100057 &100095 &100125 &100147 &100177 &100215 &100245 &100267\end{tabular}The solution is \( \text{Non-Linear Power} \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( \text{Exponential} \)
...
\end{center}
The solution is \( C(h) = 2.36 h + 786.60 \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 4.60 h \)
