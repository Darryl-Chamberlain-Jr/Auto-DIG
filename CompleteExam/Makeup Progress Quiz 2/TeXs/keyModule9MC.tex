...
\end{center}
The solution is \( 0.368 D \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( 25.000 D \)
...
* This is the correct option as the model should be $B(x) = 1260 - 11600 x$.
\end{enumerate}
...
\end{center}
The solution is \( B(x) = 9000 - 1612 x \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( B(x) = 7388 x \)
...
\textbf{Pop} &69840 &69360 &67440 &59760 &29040 &0 &0 &0 &0\end{tabular}The solution is \( \text{Exponential} \), which is option C.\begin{enumerate}[label=\Alph*.]
...
\end{center}
The solution is \( C(h) = 2.00 h + 281.60 \), which is option D.\begin{enumerate}[label=\Alph*.]
...
\begin{tabular}{c|c|c|c|c|c|c|c|c|c}
\textbf{Year} &1 &2 &3 &4 &5 &6 &7 &8 &9\tabularnewline \hline
\textbf{Pop} &30000 &30020 &30032 &30041 &30048 &30053 &30058 &30062 &30065\end{tabular}The solution is \( \text{Logarithmic} \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( \text{Logarithmic} \)
...
\end{center}
The solution is \( C(h) = -1.38 h + 1324.80 \), which is option A.\begin{enumerate}[label=\Alph*.]
