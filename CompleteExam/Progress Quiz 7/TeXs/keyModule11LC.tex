...
\[ \lim_{x \rightarrow 6^+} \frac{6}{(x-6)^6}+5 \]The solution is \( \infty \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( \infty \)
...
\litem{
Evaluate the one-sided limit of the function $f(x)$ below, if possible.
\[ \lim_{x \rightarrow -5^-} \frac{6}{(x-5)^9}+4 \]The solution is \( f(-5) \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( f(-5) \)
...
\[ \lim_{x \rightarrow 9} \frac{\sqrt{5x - 20} - 5}{9x - 81} \]The solution is \( \text{None of the above} \), which is option E.\begin{enumerate}[label=\Alph*.]
\item \( 0.011 \)
...
* This is the correct option as the limit is 0.056.
\end{enumerate}
...
\litem{
Evaluate the limit below, if possible.
\[ \lim_{x \rightarrow 6} \frac{\sqrt{8x - 23} - 5}{3x - 18} \]The solution is \( 0.267 \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( 0.943 \)
...
\end{center}
The solution is \( f(x) \text{ is close to or exactly } 3.475 \text{ when } x \text{ is close to } 9 \), which is option A.\begin{enumerate}[label=\Alph*.]
