...
\textbf{Pop} &30000 &30020 &30032 &30041 &30048 &30053 &30058 &30062 &30065\end{tabular}The solution is \( \text{Logarithmic} \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( \text{Linear} \)
...
* This is the correct option as the model should be $B(x) = 1304 - 7600 x$.
\end{enumerate}
...
\end{center}
The solution is \( C(h) = 1.55 h + 905.00 \), which is option A.\begin{enumerate}[label=\Alph*.]
...
\begin{tabular}{c|c|c|c|c|c|c|c|c|c}
\textbf{Year} &1 &2 &3 &4 &5 &6 &7 &8 &9\tabularnewline \hline
\textbf{Pop} &79950 &79900 &79850 &79800 &79750 &79700 &79650 &79600 &79550\end{tabular}The solution is \( \text{Linear} \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( \text{Non-Linear Power} \)
...
\end{center}
The solution is \( C(h) = 2.89 h + 604.80 \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 3.96 h \)
