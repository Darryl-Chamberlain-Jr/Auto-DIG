...
* This is the correct option as the model should be $C(x) = 1220 x$.
\end{enumerate}
...
\end{center}
The solution is \( 0.492 D \), which is option C.\begin{enumerate}[label=\Alph*.]
\item \( 19.000 D \)
...
* This is the correct option as the model should be $C(x) = 1068 x$.
\end{enumerate}
...
\end{center}
The solution is \( C(h) = 1.94 h + 538.90 \), which is option C.\begin{enumerate}[label=\Alph*.]
...
\end{center}
The solution is \( 0.434 D \), which is option C.\begin{enumerate}[label=\Alph*.]
\item \( 385.000 D \)
...
\end{center}
The solution is \( C(h) = -1.47 h + 879.00 \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 4.39 h \)
