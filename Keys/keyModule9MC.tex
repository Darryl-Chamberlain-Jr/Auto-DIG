...
\end{center}
The solution is \( C(h) = 2.37 h + 319.50 \), which is option C.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 3.31 h \)
...
* This is the correct option as the model should be $I(x) = 8600$.
\end{enumerate}
...
\textbf{Pop} &80026 &80056 &80094 &80124 &80146 &80176 &80214 &80244 &80266\end{tabular}The solution is \( \text{Non-Linear Power} \), which is option A.\begin{enumerate}[label=\Alph*.]
...
* This is the correct option as the model should be $C(x) = 1420 x$.
\end{enumerate}
...
\end{center}
The solution is \( C(h) = -2.11 h + 330.40 \), which is option A.\begin{enumerate}[label=\Alph*.]
...
* This is the correct option. Since the time spent on each path was equal, the distance of each path must be different. The model would be $0.500D_u + 0.125D_d + 0.200D_f$, where $D_u$ is distance traveling up the hill, $D_d$ is distance traveling down, and $D_f$ is distance traveling on a flat part.
...
\end{center}
The solution is \( 24 t \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( 440 t \)
