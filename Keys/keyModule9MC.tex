...
The solution is \( 18 t \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( 18 t \)
...
The solution is \( C(h) = -2.84 h + 747.60 \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 4.81 h \)
...
The solution is \( C(h) = 1.65 h + 835.20 \), which is option C.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 5.46 h \)
...
* This is the correct option as the model should be $C(x) = 1252 x$.
\end{enumerate}
...
The solution is \( 0.492 D \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( 0.492 D \)
