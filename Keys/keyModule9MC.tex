...
\end{center}
The solution is \( C(h) = 3.00 h + 910.00 \), which is option A.\begin{enumerate}[label=\Alph*.]
...
\textbf{Pop} &30000 &30013 &30021 &30027 &30032 &30035 &30038 &30041 &30043\end{tabular}The solution is \( \text{Logarithmic} \), which is option B.\begin{enumerate}[label=\Alph*.]
...
\end{center}
The solution is \( C(x) = 1396 x \), which is option C.\begin{enumerate}[label=\Alph*.]
\item \( C(x) = 1396 \)
...
\begin{tabular}{c|c|c|c|c|c|c|c|c|c}
\textbf{Year} &1 &2 &3 &4 &5 &6 &7 &8 &9\tabularnewline \hline
\textbf{Pop} &60044 &60084 &60124 &60164 &60204 &60244 &60284 &60324 &60364\end{tabular}The solution is \( \text{Non-Linear Power} \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( \text{Non-Linear Power} \)
...
\end{center}
The solution is \( C(x) = 1168 x \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( C(x) = 892 \)
...
\end{center}
The solution is \( 0.492 D \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( 240.000 D \)
...
\end{center}
The solution is \( 0.561 D \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( 0.561 D \)
...
\end{center}
The solution is \( C(h) = 2.55 h + 420.30 \), which is option A.\begin{enumerate}[label=\Alph*.]
