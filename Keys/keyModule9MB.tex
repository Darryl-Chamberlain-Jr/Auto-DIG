...
\end{center}
The solution is \( C(h) = 2.70 h + 343.20 \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 4.21 h \)
...
\textbf{Pop} &60016 &60044 &60056 &60084 &60096 &60124 &60136 &60164 &60176\end{tabular}The solution is \( \text{Non-Linear Power} \), which is option C.\begin{enumerate}[label=\Alph*.]
...
* This is the correct option as the model should be $I(x) = 7400$.
\end{enumerate}
...
\begin{tabular}{c|c|c|c|c|c|c|c|c|c}
\textbf{Year} &1 &2 &3 &4 &5 &6 &7 &8 &9\tabularnewline \hline
\textbf{Pop} &40030 &40060 &40090 &40120 &40150 &40180 &40210 &40240 &40270\end{tabular}The solution is \( \text{Linear} \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( \text{Logarithmic} \)
...
* This is the correct option as the model should be $I(x) = 8000$.
\end{enumerate}
...
* This is the correct option. Since the paths are equal length and the bike can travel different speeds on each part, the time spent on each path is not equal! The model would be $6t_u + 12t_d +8t_f$, where $t_u$ is time traveling up, $t_d$ is time traveling down, and $t_f$ is time traveling on a flat portion.
...
\end{center}
The solution is \( C(h) = -2.35 h + 1099.80 \), which is option A.\begin{enumerate}[label=\Alph*.]
