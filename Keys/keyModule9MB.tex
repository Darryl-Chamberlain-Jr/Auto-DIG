...
* This is the correct option as the model should be $C(x) = 1304 x$.
\end{enumerate}
...
The solution is \( C(h) = 2.04 h + 608.00 \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 5.08 h \)
...
* This is the correct option as the model should be $C(x) = 1052 x$.
\end{enumerate}
...
The solution is \( 0.843 D \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( 0.843 D \)
...
The solution is \( C(h) = 1.57 h + 752.40 \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 4.21 h \)
