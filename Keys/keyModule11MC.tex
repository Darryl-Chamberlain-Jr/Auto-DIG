...
\begin{center}
    \textit{ Uranium is taken out of the reactor with a temperature of $120^{\circ}$ C and is placed into a $16^{\circ}$ C bath to cool. After 10 minutes, the uranium has cooled to $75^{\circ}$ C. }
\end{center}
The solution is \( k = -0.05669 \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( k = -0.05669 \)
...
\begin{center}
    \textit{ Uranium is taken out of the reactor with a temperature of $200^{\circ}$ C and is placed into a $20^{\circ}$ C bath to cool. After 37 minutes, the uranium has cooled to $156^{\circ}$ C. }
\end{center}
The solution is \( k = -0.00758 \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( k = -0.00758 \)
...
\begin{center}
    \textit{ A newly discovered bacteria, $\alpha$, is being examined in a lab. The lab started with a petri dish of 2 bacteria-$\alpha$. After 2 hours, the petri dish has 61 bacteria-$\alpha$. Based on similar bacteria, the lab believes bacteria-$\alpha$ doubles after some undetermined number of minutes. }
\end{center}
The solution is \( \text{None of the above} \), which is option E.\begin{enumerate}[label=\Alph*.]
\item \( \text{About } 52 \text{ minutes} \)
...
\item \( \text{About } 313 \text{ minutes} \)
...
\textbf{Pop} &70040 &70080 &70120 &70160 &70200 &70240 &70280 &70320 &70360\end{tabular}The solution is \( \text{Linear} \), which is option D.\begin{enumerate}[label=\Alph*.]
...
\begin{center}
    \textit{ The half-life of an element is the amount of time it takes for the element to decay to half of its initial starting amount. There is initially 607 grams of element $X$ and after 5 years there is 121 grams remaining. }
\end{center}
...
\begin{tabular}{c|c|c|c|c|c|c|c|c|c}
\textbf{Year} &1 &2 &3 &4 &5 &6 &7 &8 &9\tabularnewline \hline
\textbf{Pop} &59978 &59966 &59938 &59926 &59898 &59886 &59858 &59846 &59818\end{tabular}The solution is \( \text{Non-Linear Power} \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( \text{Exponential} \)
...
\begin{center}
    \textit{ The half-life of an element is the amount of time it takes for the element to decay to half of its initial starting amount. There is initially 876 grams of element $X$ and after 15 years there is 146 grams remaining. }
\end{center}
The solution is \( \text{About } 1825 \text{ days} \), which is option D.\begin{enumerate}[label=\Alph*.]
...
\begin{center}
    \textit{ A newly discovered bacteria, $\alpha$, is being examined in a lab. The lab started with a petri dish of 3 bacteria-$\alpha$. After 3 hours, the petri dish has 50499 bacteria-$\alpha$. Based on similar bacteria, the lab believes bacteria-$\alpha$ quadruples after some undetermined number of minutes. }
\end{center}
The solution is \( \text{None of the above} \), which is option E.\begin{enumerate}[label=\Alph*.]
...
This uses the wrong base and does not solve for the constant correctly.
\item \( \text{About } 178 \text{ minutes} \)
