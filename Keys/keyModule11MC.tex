...
\begin{center}
    \textit{ A newly discovered bacteria, $\alpha$, is being examined in a lab. The lab started with a petri dish of 3 bacteria-$\alpha$. After 3 hours, the petri dish has 76 bacteria-$\alpha$. Based on similar bacteria, the lab believes bacteria-$\alpha$ doubles after some undetermined number of minutes. }
\end{center}
...
\item \( \text{About } 445 \text{ minutes} \)
...
\hline
\textbf{Pop.} & 30000 & 29979 & 29967 & 29958 & 29951 & 29946 & 29941 & 29937 & 29934
\end{tabular} 
...
\begin{center}
    \textit{ The half-life of an element is the amount of time it takes for the element to decay to half of its initial starting amount. There is initially 920 grams of element $X$ and after 20 years there is 92 grams remaining. }
\end{center}


The solution is \( \text{About } 2190 \text{ days} \), which is option C.\begin{enumerate}[label=\Alph*.]
...
\begin{center}
    \textit{ A newly discovered bacteria, $\alpha$, is being examined in a lab. The lab started with a petri dish of 4 bacteria-$\alpha$. After 1 hours, the petri dish has 64 bacteria-$\alpha$. Based on similar bacteria, the lab believes bacteria-$\alpha$ triples after some undetermined number of minutes. }
\end{center}
...
\begin{center}
    \textit{ Uranium is taken out of the reactor with a temperature of $110^{\circ}$ C and is placed into a $14^{\circ}$ C bath to cool. After 13 minutes, the uranium has cooled to $70^{\circ}$ C. }
\end{center}
...
* This is the correct answer as $k = -0.04146$.
\end{enumerate}
...
\begin{center}
    \textit{ The half-life of an element is the amount of time it takes for the element to decay to half of its initial starting amount. There is initially 680 grams of element $X$ and after 7 years there is 75 grams remaining. }
\end{center}
...
\begin{center}
    \textit{ Uranium is taken out of the reactor with a temperature of $170^{\circ}$ C and is placed into a $11^{\circ}$ C bath to cool. After 28 minutes, the uranium has cooled to $108^{\circ}$ C. }
\end{center}


The solution is \( k = -0.01765 \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( k = -0.02663 \)
