...
\begin{center}
    \textit{ The half-life of an element is the amount of time it takes for the element to decay to half of its initial starting amount. There is initially 653 grams of element $X$ and after 12 years there is 81 grams remaining. }
\end{center}
...
\begin{center}
    \textit{ The half-life of an element is the amount of time it takes for the element to decay to half of its initial starting amount. There is initially 633 grams of element $X$ and after 16 years there is 63 grams remaining. }
\end{center}
The solution is \( \text{About } 1460 \text{ days} \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( \text{About } 365 \text{ days} \)

This models half-life as a linear function.
\item \( \text{About } 8030 \text{ days} \)
...
\textbf{Pop} &90090 &90270 &90810 &92430 &97290 &111870 &155610 &286830 &680490\end{tabular}The solution is \( \text{Exponential} \), which is option A.\begin{enumerate}[label=\Alph*.]
...
\begin{center}
    \textit{ Uranium is taken out of the reactor with a temperature of $150^{\circ}$ C and is placed into a $12^{\circ}$ C bath to cool. After 36 minutes, the uranium has cooled to $97^{\circ}$ C. }
\end{center}
The solution is \( k = -0.01346 \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( k = -0.01578 \)
...
\begin{center}
    \textit{ A newly discovered bacteria, $\alpha$, is being examined in a lab. The lab started with a petri dish of 3 bacteria-$\alpha$. After 3 hours, the petri dish has 382441 bacteria-$\alpha$. Based on similar bacteria, the lab believes bacteria-$\alpha$ quadruples after some undetermined number of minutes. }
\end{center}
The solution is \( \text{About } 21 \text{ minutes} \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( \text{About } 21 \text{ minutes} \)

* This is the correct option.
\item \( \text{About } 127 \text{ minutes} \)

This solves for the constant correctly but converted incorrectly.
\item \( \text{About } 208 \text{ minutes} \)
...
\begin{center}
    \textit{ Uranium is taken out of the reactor with a temperature of $140^{\circ}$ C and is placed into a $10^{\circ}$ C bath to cool. After 28 minutes, the uranium has cooled to $87^{\circ}$ C. }
\end{center}
...
* This is the correct answer as $k = -0.01870$.
\end{enumerate}
...
\begin{center}
    \textit{ A newly discovered bacteria, $\alpha$, is being examined in a lab. The lab started with a petri dish of 4 bacteria-$\alpha$. After 3 hours, the petri dish has 274 bacteria-$\alpha$. Based on similar bacteria, the lab believes bacteria-$\alpha$ doubles after some undetermined number of minutes. }
\end{center}
The solution is \( \text{None of the above} \), which is option E.\begin{enumerate}[label=\Alph*.]
\item \( \text{About } 280 \text{ minutes} \)
...
\item \( \text{About } 477 \text{ minutes} \)
