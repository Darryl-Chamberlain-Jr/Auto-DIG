...
\begin{center}
    \textit{ Uranium is taken out of the reactor with a temperature of $140^{\circ}$ C and is placed into a $13^{\circ}$ C bath to cool. After 38 minutes, the uranium has cooled to $75^{\circ}$ C. }
\end{center}
The solution is \( k = -0.01887 \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( k = -0.02143 \)
...
\begin{center}
    \textit{ A newly discovered bacteria, $\alpha$, is being examined in a lab. The lab started with a petri dish of 2 bacteria-$\alpha$. After 1 hours, the petri dish has 18 bacteria-$\alpha$. Based on similar bacteria, the lab believes bacteria-$\alpha$ quadruples after some undetermined number of minutes. }
\end{center}
The solution is \( \text{About } 36 \text{ minutes} \), which is option D.\begin{enumerate}[label=\Alph*.]
...
\begin{center}
    \textit{ The half-life of an element is the amount of time it takes for the element to decay to half of its initial starting amount. There is initially 800 grams of element $X$ and after 4 years there is 160 grams remaining. }
\end{center}
...
\begin{center}
    \textit{ A newly discovered bacteria, $\alpha$, is being examined in a lab. The lab started with a petri dish of 4 bacteria-$\alpha$. After 2 hours, the petri dish has 243 bacteria-$\alpha$. Based on similar bacteria, the lab believes bacteria-$\alpha$ triples after some undetermined number of minutes. }
\end{center}
The solution is \( \text{About } 32 \text{ minutes} \), which is option C.\begin{enumerate}[label=\Alph*.]
\item \( \text{About } 325 \text{ minutes} \)
...
\textbf{Pop} &20120 &20360 &21080 &23240 &29720 &49160 &107480 &282440 &807320\end{tabular}The solution is \( \text{Exponential} \), which is option A.\begin{enumerate}[label=\Alph*.]
...
\begin{center}
    \textit{ Uranium is taken out of the reactor with a temperature of $170^{\circ}$ C and is placed into a $17^{\circ}$ C bath to cool. After 30 minutes, the uranium has cooled to $118^{\circ}$ C. }
\end{center}
...
* This is the correct answer as $k = -0.01384$.
\end{enumerate}
...
\begin{center}
    \textit{ The half-life of an element is the amount of time it takes for the element to decay to half of its initial starting amount. There is initially 510 grams of element $X$ and after 6 years there is 72 grams remaining. }
\end{center}
...
\begin{tabular}{c|c|c|c|c|c|c|c|c|c}
\textbf{Year} &1 &2 &3 &4 &5 &6 &7 &8 &9\tabularnewline \hline
\textbf{Pop} &89840 &89360 &87440 &79760 &49040 &0 &0 &0 &0\end{tabular}The solution is \( \text{Exponential} \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( \text{Exponential} \)
...
\begin{tabular}{c|c|c|c|c|c|c|c|c|c}
\textbf{Year} &1 &2 &3 &4 &5 &6 &7 &8 &9\tabularnewline \hline
\textbf{Pop} &40000 &39986 &39978 &39972 &39967 &39964 &39961 &39958 &39956\end{tabular}The solution is \( \text{Logarithmic} \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( \text{Logarithmic} \)
...
\begin{center}
    \textit{ Uranium is taken out of the reactor with a temperature of $100^{\circ}$ C and is placed into a $13^{\circ}$ C bath to cool. After 36 minutes, the uranium has cooled to $50^{\circ}$ C. }
\end{center}
The solution is \( \text{None of the above} \), which is option E.\begin{enumerate}[label=\Alph*.]
\item \( k = -0.02762 \)
...
* This is the correct answer as $k = -0.02375$.
\end{enumerate}
...
\begin{center}
    \textit{ A newly discovered bacteria, $\alpha$, is being examined in a lab. The lab started with a petri dish of 3 bacteria-$\alpha$. After 1 hours, the petri dish has 80 bacteria-$\alpha$. Based on similar bacteria, the lab believes bacteria-$\alpha$ triples after some undetermined number of minutes. }
\end{center}
The solution is \( \text{About } 20 \text{ minutes} \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( \text{About } 180 \text{ minutes} \)
...
\begin{center}
    \textit{ The half-life of an element is the amount of time it takes for the element to decay to half of its initial starting amount. There is initially 992 grams of element $X$ and after 2 years there is 198 grams remaining. }
\end{center}
The solution is \( \text{About } 0 \text{ days} \), which is option A.\begin{enumerate}[label=\Alph*.]
...
\begin{center}
    \textit{ A newly discovered bacteria, $\alpha$, is being examined in a lab. The lab started with a petri dish of 4 bacteria-$\alpha$. After 1 hours, the petri dish has 79 bacteria-$\alpha$. Based on similar bacteria, the lab believes bacteria-$\alpha$ quadruples after some undetermined number of minutes. }
\end{center}
The solution is \( \text{None of the above} \), which is option E.\begin{enumerate}[label=\Alph*.]
...
This uses the wrong base and solves for the constant correctly but converted incorrectly.
\item \( \text{About } 170 \text{ minutes} \)
...
\begin{tabular}{c|c|c|c|c|c|c|c|c|c}
\textbf{Year} &1 &2 &3 &4 &5 &6 &7 &8 &9\tabularnewline \hline
\textbf{Pop} &80000 &79972 &79956 &79944 &79935 &79928 &79922 &79916 &79912\end{tabular}The solution is \( \text{Logarithmic} \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( \text{Linear} \)
...
\begin{center}
    \textit{ Uranium is taken out of the reactor with a temperature of $180^{\circ}$ C and is placed into a $19^{\circ}$ C bath to cool. After 38 minutes, the uranium has cooled to $121^{\circ}$ C. }
\end{center}
The solution is \( k = -0.01201 \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( k = -0.01495 \)
...
\begin{center}
    \textit{ The half-life of an element is the amount of time it takes for the element to decay to half of its initial starting amount. There is initially 876 grams of element $X$ and after 4 years there is 125 grams remaining. }
\end{center}
...
\begin{tabular}{c|c|c|c|c|c|c|c|c|c}
\textbf{Year} &1 &2 &3 &4 &5 &6 &7 &8 &9\tabularnewline \hline
\textbf{Pop} &20000 &20020 &20032 &20041 &20048 &20053 &20058 &20062 &20065\end{tabular}The solution is \( \text{Logarithmic} \), which is option C.\begin{enumerate}[label=\Alph*.]
\item \( \text{Non-Linear Power} \)
