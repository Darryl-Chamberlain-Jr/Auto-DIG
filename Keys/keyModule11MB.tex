...
\begin{center}
    \textit{ A newly discovered bacteria, $\alpha$, is being examined in a lab. The lab started with a petri dish of 3 bacteria-$\alpha$. After 2 hours, the petri dish has 961 bacteria-$\alpha$. Based on similar bacteria, the lab believes bacteria-$\alpha$ quadruples after some undetermined number of minutes. }
\end{center}


The solution is \( \text{None of the above} \), which is option E.\begin{enumerate}[label=\Alph*.]
\item \( \text{About } 86 \text{ minutes} \)

This uses the wrong base and solves for the constant correctly but converted incorrectly.
\item \( \text{About } 187 \text{ minutes} \)
...
\hline
\textbf{Pop.} & 89980 & 89960 & 89940 & 89920 & 89900 & 89880 & 89860 & 89840 & 89820
\end{tabular} 
...
\begin{center}
    \textit{ The half-life of an element is the amount of time it takes for the element to decay to half of its initial starting amount. There is initially 797 grams of element $X$ and after 14 years there is 199 grams remaining. }
\end{center}


The solution is \( \text{About } 2190 \text{ days} \), which is option A.\begin{enumerate}[label=\Alph*.]
...
\begin{center}
    \textit{ A newly discovered bacteria, $\alpha$, is being examined in a lab. The lab started with a petri dish of 4 bacteria-$\alpha$. After 1 hours, the petri dish has 94 bacteria-$\alpha$. Based on similar bacteria, the lab believes bacteria-$\alpha$ triples after some undetermined number of minutes. }
\end{center}


The solution is \( \text{None of the above} \), which is option E.\begin{enumerate}[label=\Alph*.]
\item \( \text{About } 78 \text{ minutes} \)
...
This uses the wrong base.
\item \( \text{About } 164 \text{ minutes} \)
...
\begin{center}
    \textit{ Uranium is taken out of the reactor with a temperature of $190^{\circ}$ C and is placed into a $14^{\circ}$ C bath to cool. After 39 minutes, the uranium has cooled to $132^{\circ}$ C. }
\end{center}
...
* This is the correct answer as $k = -0.01025$.
\end{enumerate}
...
\begin{center}
    \textit{ The half-life of an element is the amount of time it takes for the element to decay to half of its initial starting amount. There is initially 652 grams of element $X$ and after 8 years there is 130 grams remaining. }
\end{center}
...
\begin{center}
    \textit{ Uranium is taken out of the reactor with a temperature of $100^{\circ}$ C and is placed into a $18^{\circ}$ C bath to cool. After 18 minutes, the uranium has cooled to $56^{\circ}$ C. }
\end{center}
...
* This is the correct answer as $k = -0.04273$.
\end{enumerate}
...
\textbf{Year} & 1 & 2 & 3 & 4 & 5 & 6 & 7 & 8 & 9 \tabularnewline
\hline
\textbf{Pop.} & 20020 & 20040 & 20060 & 20080 & 20100 & 20120 & 20140 & 20160 & 20180
\end{tabular} 
