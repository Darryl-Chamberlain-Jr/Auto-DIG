...
The solution is \( 0.843 D \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( 70.000 D \)
...
The solution is \( C(h) = 1.06 h + 786.60 \), which is option C.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 5.20 h \)
...
The solution is \( I(x) = 9400 \), which is option C.\begin{enumerate}[label=\Alph*.]
\item \( I(x) = 9400 x \)
...
The solution is \( C(h) = -1.66 h + 905.80 \), which is option D.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 5.64 h \)
...
* This is the correct option as the model should be $C(x) = 1496 x$.
\end{enumerate}
