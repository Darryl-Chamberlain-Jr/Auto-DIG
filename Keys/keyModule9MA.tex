...
The solution is \( 0.454 D \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( 0.454 D \)
...
The solution is \( C(x) = 1640 x \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( C(x) = 1640 x \)
...
The solution is \( C(h) = 1.88 h + 708.00 \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 4.83 h \)
...
* This is the correct option as the model should be $I(x) = 7000$.
\end{enumerate}
...
The solution is \( C(h) = 2.37 h + 774.40 \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( C(h) = 4.71 h \)
