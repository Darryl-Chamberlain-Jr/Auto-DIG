...
The solution is \( f(x)=\frac{x^{3} -4 x^{2} -47 x + 210}{x^{3} +4 x^{2} -31 x -70} \), which is option A.\begin{enumerate}[label=\Alph*.]
...
\litem{
Determine the vertical asymptotes and holes in the rational function below.
\[ f(x) = \frac{8x^{3} -30 x^{2} +9 x + 27}{6x^{2} -x -12} \]The solution is \( \text{Vertical Asymptote of } x = -1.333 \text{ and hole at } x = 1.5 \), which is option A.\begin{enumerate}[label=\Alph*.]
