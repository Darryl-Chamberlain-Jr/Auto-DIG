...
\[ \lim_{x \rightarrow 9} \frac{\sqrt{5x - 20} - 5}{3x - 27} \]The solution is \( 0.167 \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( 0.167 \)
...
\[ \lim_{x \rightarrow -7^-} \frac{-8}{(x-7)^3}+3 \]The solution is \( f(-7) \), which is option A.\begin{enumerate}[label=\Alph*.]
\item \( f(-7) \)
...
\end{center}
The solution is \( f(x) \text{ is undefined when } x \text{ is close to or exactly } 5. \), which is option C.\begin{enumerate}[label=\Alph*.]
...
\end{center}
The solution is \( f(x) \text{ is undefined when } x \text{ is close to or exactly } 4. \), which is option A.\begin{enumerate}[label=\Alph*.]
...
\[ \frac{\frac{4}{x} - 1}{x - 4} \]The solution is \( \{ 4.1000, 4.0100, 4.0010, 4.0001 \} \), which is option B.\begin{enumerate}[label=\Alph*.]
...
\litem{
Evaluate the limit below, if possible.
\[ \lim_{x \rightarrow 7} \frac{\sqrt{7x - 24} - 5}{5x - 35} \]The solution is \( \text{None of the above} \), which is option E.\begin{enumerate}[label=\Alph*.]
\item \( \infty \)
...
* This is the correct option as the limit is 0.140.
\end{enumerate}
...
\[ \frac{\frac{5}{x} - 1}{x - 5} \]The solution is \( \{ 4.9000, 4.9900, 4.9990, 4.9999 \} \), which is option B.\begin{enumerate}[label=\Alph*.]
...
\litem{
Evaluate the one-sided limit of the function $f(x)$ below, if possible.
\[ \lim_{x \rightarrow 3^+} \frac{6}{(x-3)^6}+5 \]The solution is \( \infty \), which is option B.\begin{enumerate}[label=\Alph*.]
\item \( f(3) \)
