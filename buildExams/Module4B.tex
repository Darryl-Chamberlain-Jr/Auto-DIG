...
\begin{multicols}{2}
	\begin{enumerate}[label=\Alph*.]
		\item \includegraphics[width = 0.25\textwidth]{../Figures/quadraticEquationToGraphAB.png}
		\item \includegraphics[width = 0.25\textwidth]{../Figures/quadraticEquationToGraphBB.png}
		\item \includegraphics[width = 0.25\textwidth]{../Figures/quadraticEquationToGraphCB.png}
		\item \includegraphics[width = 0.25\textwidth]{../Figures/quadraticEquationToGraphDB.png}
