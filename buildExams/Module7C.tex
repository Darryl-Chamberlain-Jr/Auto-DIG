...
\begin{multicols}{2}
		\item \begin{center}
\includegraphics[width=.3\textwidth]{../Figures/rationalEquationToGraphCA.png}
\end{center}
		\item \begin{center}
\includegraphics[width=.3\textwidth]{../Figures/rationalEquationToGraphCB.png}
\end{center}
\columnbreak
		\item \begin{center}
\includegraphics[width=.3\textwidth]{../Figures/rationalEquationToGraphCC.png}
\end{center}
		\item \begin{center}
\includegraphics[width=.3\textwidth]{../Figures/rationalEquationToGraphCD.png}
\end{center}
