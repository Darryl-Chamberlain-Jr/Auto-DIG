...
\[ \sage{displayProblem} \]
  ...
  \begin{multicols}{2}
  		\item \begin{center}
  \includegraphics[width=.3\textwidth]{../Figures/radicalEquationToGraphBA.png}
  \end{center}
  		\item \begin{center}
  \includegraphics[width=.3\textwidth]{../Figures/radicalEquationToGraphBB.png}
  \end{center}
  \columnbreak
  		\item \begin{center}
  \includegraphics[width=.3\textwidth]{../Figures/radicalEquationToGraphBC.png}
  \end{center}
  		\item \begin{center}
  \includegraphics[width=.3\textwidth]{../Figures/radicalEquationToGraphBD.png}
  \end{center}
