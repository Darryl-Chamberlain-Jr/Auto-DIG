...
_sage_const_34 = Integer(34); _sage_const_39 = Integer(39); _sage_const_45 = Integer(45); _sage_const_7 = Integer(7); _sage_const_31 = Integer(31); _sage_const_49 = Integer(49); _sage_const_62 = Integer(62); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_5 = Integer(5); _sage_const_6 = Integer(6); _sage_const_64 = Integer(64); _sage_const_32 = Integer(32); _sage_const_68 = Integer(68); _sage_const_87 = Integer(87); _sage_const_8 = Integer(8); _sage_const_9 = Integer(9); _sage_const_10 = Integer(10); _sage_const_11 = Integer(11); _sage_const_89 = Integer(89); _sage_const_33 = Integer(33); _sage_const_93 = Integer(93); _sage_const_116 = Integer(116); _sage_const_12 = Integer(12); _sage_const_13 = Integer(13); _sage_const_118 = Integer(118); _sage_const_122 = Integer(122); _sage_const_135 = Integer(135); _sage_const_14 = Integer(14); _sage_const_15 = Integer(15); _sage_const_16 = Integer(16); _sage_const_17 = Integer(17); _sage_const_18 = Integer(18); _sage_const_19 = Integer(19); _sage_const_20 = Integer(20); _sage_const_137 = Integer(137); _sage_const_35 = Integer(35); _sage_const_141 = Integer(141); _sage_const_154 = Integer(154); _sage_const_21 = Integer(21); _sage_const_22 = Integer(22); _sage_const_23 = Integer(23); _sage_const_24 = Integer(24); _sage_const_25 = Integer(25); _sage_const_26 = Integer(26); _sage_const_27 = Integer(27); _sage_const_28 = Integer(28); _sage_const_29 = Integer(29)## This file (Module7C.sagetex.sage) was *autogenerated* from Module7C.tex with sagetex.sty version 2019/11/14 v3.4.
import sagetex
...
try:
 _st_.current_tex_line = _sage_const_154 
 _st_.inline(_sage_const_22 , latex(leftSide))
except:
 _st_.goboom(_sage_const_154 )
try:
 _st_.current_tex_line = _sage_const_154 
 _st_.inline(_sage_const_23 , latex(factorNumerator3))
except:
 _st_.goboom(_sage_const_154 )
try:
 _st_.current_tex_line = _sage_const_154 
 _st_.inline(_sage_const_24 , latex(factorDenominator3))
except:
 _st_.goboom(_sage_const_154 )
try:
 _st_.current_tex_line = _sage_const_154 
