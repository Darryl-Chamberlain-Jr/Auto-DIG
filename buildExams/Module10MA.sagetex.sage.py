...
# This file was *autogenerated* from the file /home/dchamberlain31/git-repos/AAG-College-Algebra/buildExams/Module10MA.sagetex.sage
from sage.all_cmdline import *   # import sage library

_sage_const_35 = Integer(35); _sage_const_42 = Integer(42); _sage_const_48 = Integer(48); _sage_const_46 = Integer(46); _sage_const_52 = Integer(52); _sage_const_66 = Integer(66); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_5 = Integer(5); _sage_const_68 = Integer(68); _sage_const_47 = Integer(47); _sage_const_72 = Integer(72); _sage_const_87 = Integer(87); _sage_const_6 = Integer(6); _sage_const_7 = Integer(7); _sage_const_8 = Integer(8); _sage_const_9 = Integer(9); _sage_const_10 = Integer(10); _sage_const_11 = Integer(11); _sage_const_12 = Integer(12); _sage_const_89 = Integer(89); _sage_const_93 = Integer(93); _sage_const_108 = Integer(108); _sage_const_13 = Integer(13); _sage_const_14 = Integer(14); _sage_const_15 = Integer(15); _sage_const_16 = Integer(16); _sage_const_17 = Integer(17); _sage_const_18 = Integer(18); _sage_const_19 = Integer(19); _sage_const_110 = Integer(110); _sage_const_49 = Integer(49); _sage_const_114 = Integer(114); _sage_const_131 = Integer(131); _sage_const_20 = Integer(20); _sage_const_21 = Integer(21); _sage_const_22 = Integer(22); _sage_const_23 = Integer(23); _sage_const_24 = Integer(24); _sage_const_25 = Integer(25); _sage_const_26 = Integer(26); _sage_const_27 = Integer(27); _sage_const_28 = Integer(28); _sage_const_29 = Integer(29); _sage_const_30 = Integer(30); _sage_const_31 = Integer(31); _sage_const_32 = Integer(32); _sage_const_33 = Integer(33); _sage_const_34 = Integer(34); _sage_const_133 = Integer(133); _sage_const_50 = Integer(50); _sage_const_137 = Integer(137); _sage_const_152 = Integer(152); _sage_const_36 = Integer(36); _sage_const_37 = Integer(37); _sage_const_38 = Integer(38); _sage_const_39 = Integer(39); _sage_const_40 = Integer(40); _sage_const_41 = Integer(41)## This file (Module10MA.sagetex.sage) was *autogenerated* from Module10MA.tex with sagetex.sty version 2019/11/14 v3.4.
import sagetex
...
try:
 _st_.current_tex_line = _sage_const_131 
 _st_.inline(_sage_const_21 , latex(populations[_sage_const_0 ]))
except:
 _st_.goboom(_sage_const_131 )
try:
 _st_.current_tex_line = _sage_const_131 
 _st_.inline(_sage_const_22 , latex(populations[_sage_const_1 ]))
except:
 _st_.goboom(_sage_const_131 )
try:
 _st_.current_tex_line = _sage_const_131 
 _st_.inline(_sage_const_23 , latex(populations[_sage_const_2 ]))
except:
 _st_.goboom(_sage_const_131 )
try:
 _st_.current_tex_line = _sage_const_131 
 _st_.inline(_sage_const_24 , latex(populations[_sage_const_3 ]))
except:
 _st_.goboom(_sage_const_131 )
try:
 _st_.current_tex_line = _sage_const_131 
 _st_.inline(_sage_const_25 , latex(populations[_sage_const_4 ]))
except:
 _st_.goboom(_sage_const_131 )
try:
 _st_.current_tex_line = _sage_const_131 
 _st_.inline(_sage_const_26 , latex(populations[_sage_const_5 ]))
except:
 _st_.goboom(_sage_const_131 )
try:
 _st_.current_tex_line = _sage_const_131 
 _st_.inline(_sage_const_27 , latex(populations[_sage_const_6 ]))
except:
 _st_.goboom(_sage_const_131 )
try:
 _st_.current_tex_line = _sage_const_131 
 _st_.inline(_sage_const_28 , latex(populations[_sage_const_7 ]))
except:
 _st_.goboom(_sage_const_131 )
try:
 _st_.current_tex_line = _sage_const_131 
 _st_.inline(_sage_const_29 , latex(populations[_sage_const_8 ]))
except:
 _st_.goboom(_sage_const_131 )
try:
 _st_.current_tex_line = _sage_const_131 
