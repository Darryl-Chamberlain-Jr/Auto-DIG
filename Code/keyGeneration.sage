...
def writeToKey(HWorEXAM, keyFileName, version, problemNumber, stem, problemDisplayType, problem, solutionDisplayType, solution, answer, items, itemComments, generalComment):
    if HWorEXAM == "HW":
        print("No keys needed here.")
    else:
