...
displaySolution = displayComplexFactor(solution)
...
distractor1Interval = [c1, " $%s$, which corresponds to adding a minus sign in the first term." %displayComplexFactor(distractor1), 0]
distractor2Interval = [c2, " $%s$, which corresponds to adding a minus sign in the second term." %displayComplexFactor(distractor2), 0]
distractor3Interval = [c3, " $%s$, which corresponds to adding a minus sign in both terms." %displayComplexFactor(distractor3), 0]
distractor4Interval = [c4, " $%s$, which corresponds to just multiplying the real terms to get the real part of the solution and the coefficients in the complex terms to get the complex part."%displayComplexFactor(distractor4), 0]
