...
# NEW!!!!!
thisQuestion="divideComplex"
displayStemType="Math Mode"
displayProblemType="Math Mode"
displayOptionsType="Math Mode"
writeToDatabase(DIR, database_name, question_list, thisQuestion, displayStemType, displayStem, displayProblemType, displayProblem, displayOptionsType, choices, choiceComments, solution, answerLetter, generalComment)
