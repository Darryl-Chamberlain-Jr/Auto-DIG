...
def generateGraphs(aCoeffFtG, vertexFtG):
    ...
    plt.ylabel('y')
    plt.grid(True)
    plt.savefig('../Figures/quadraticEquationToGraphCopy' + figureAnswerList[0][0] + str(version) + '.png', bbox_inches='tight')
    plt.close()
    ...
    plt.ylabel('y')
    plt.grid(True)
    plt.savefig('../Figures/quadraticEquationToGraphCopy' + figureAnswerList[1][0] + str(version) + '.png', bbox_inches='tight')
    plt.close()
    ...
    plt.ylabel('y')
    plt.grid(True)
    plt.savefig('../Figures/quadraticEquationToGraphCopy' + figureAnswerList[2][0] + str(version) + '.png', bbox_inches='tight')
    plt.close()
    ...
    plt.ylabel('y')
    plt.grid(True)
    plt.savefig('../Figures/quadraticEquationToGraphCopy' + figureAnswerList[3][0] + str(version) + '.png', bbox_inches='tight')
    plt.close()
...
displaySolution = "quadraticEquationToGraphCopy%s%s" %(figureAnswerList[0][0], version)
generalComment = "Remember that Vertex Form is $y = a(x-h)^2+k$, where the vertex is $(h, k)$."

c0 = "quadraticEquationToGraphCopyA%s" %version
c1 = "quadraticEquationToGraphCopyB%s" %version
c2 = "quadraticEquationToGraphCopyC%s" %version
c3 = "quadraticEquationToGraphCopyD%s" %version
...
thisQuestion="quadraticEquationToGraphCopy"
