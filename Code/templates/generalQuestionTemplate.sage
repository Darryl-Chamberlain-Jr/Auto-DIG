...
# answerList should be created as a list of sets, where each set is [choice, comment, correctIndicator].
    ...
    # *correctIndicator* is 1 for the correct option and 0 otherwise. This is used to note the correct letter for the question.
